...
const PageWrapper = ({ children }) => {
  return (
    <div className="min-h-screen bg-[#FFF9DB] flex justify-center items-start px-4 py-20 relative overflow-hidden">
      ...
      {/* Paperclip */}
      <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-24 h-10 bg-gradient-to-b from-[#d4d4d4] to-[#a1a1a1] rounded-b-xl border-[3px] border-black shadow-[0px_4px_0px_black] flex justify-center items-center z-30">
        <div className="w-4 h-4 bg-[#FFF9DB] border-2 border-black rounded-full shadow-[1px_1px_0px_black]" />
      </div>

      {/* NavMenu right under the clip */}
      ...
      {/* Notepad Body */}
      <div className="relative w-full max-w-3xl mt-[-5px] bg-[#FEFEFE] border-[3px] border-black rounded-[1.5rem] shadow-[10px_10px_0px_#000] p-8
